...
public class MinionContext extends Actor
{
     ...
     */
    public AllMinionState minionS;
    public AllMinionState minion;
    public AllMinionState minionL;
    public static AllMinionState currentState;
    
    public World w;
    
    //Declaring static variables to get a single instance of this class
    public static MinionContext getInstanceMinion; // this would be used by the child classes of AllMinionState
    ...
    public void setState(AllMinionState state){
        this.currentState = state;
    }
    
    public AllMinionState getMinion(){
        return new Minion();
    }
    
    public AllMinionState getMinionSmall(){
        return new MinionS();
    }
    
    public AllMinionState getMinionGun(){
